    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            <div className="space-y-1">
              ...
              <p className="text-sm text-slate-600 font-medium">Advanced structural engineering analysis tool</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
          ...
          {/* Governing Equations */}
          <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-2xl shadow-xl ring-1 ring-slate-200 p-8 transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
            <h2 className="text-2xl font-bold text-slate-800 mb-6 flex items-center gap-2">
              <div className="w-1 h-8 bg-gradient-to-b from-blue-600 to-cyan-600 rounded-full"></div>
              Governing Equations
            </h2>
            <div className="space-y-6">
              <div className="p-5 bg-gradient-to-br from-blue-50 to-cyan-50/50 rounded-xl border border-blue-100 shadow-sm transition-all duration-300 hover:shadow-md hover:border-blue-200">
                <p className="text-sm font-semibold text-blue-900 mb-3 tracking-wide">Total Axial Force per Bolt:</p>
                <BlockMath math="N_t = \alpha \left(\frac{N}{n} + \frac{M_b y}{2y_m^2} + \frac{M_m x}{2x_m^2}\right)" />
              </div>
              <div className="p-5 bg-gradient-to-br from-teal-50 to-emerald-50/50 rounded-xl border border-teal-100 shadow-sm transition-all duration-300 hover:shadow-md hover:border-teal-200">
                <p className="text-sm font-semibold text-teal-900 mb-3 tracking-wide">Resultant Shear Force per Bolt:</p>
                <BlockMath math="V_r = \sqrt{\left(\frac{V_x}{n} + \frac{T_b y}{I_{bp}}\right)^2 + \left(\frac{V_y}{n} + \frac{T_b x}{I_{bp}}\right)^2}" />
              </div>
              <div className="p-5 bg-gradient-to-br from-cyan-50 to-blue-50/50 rounded-xl border border-cyan-100 shadow-sm transition-all duration-300 hover:shadow-md hover:border-cyan-200">
                <p className="text-sm font-semibold text-cyan-900 mb-3 tracking-wide">Combined Shear and Tension Check:</p>
        ...
        <div className="bg-white rounded-2xl shadow-xl ring-1 ring-slate-200 p-8 mb-10 transform transition-all duration-300 hover:shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            {/* Bolt Layout Section */}
            <div className="space-y-5">
              <h3 className="text-xl font-bold text-slate-800 flex items-center gap-2 pb-3 border-b-2 border-blue-600">
                <div className="w-1.5 h-6 bg-gradient-to-b from-blue-600 to-cyan-600 rounded-full"></div>
                Bolt Layout
              </h3>
            ...
            <div className="space-y-5">
              <h3 className="text-xl font-bold text-slate-800 flex items-center gap-2 pb-3 border-b-2 border-teal-600">
                <div className="w-1.5 h-6 bg-gradient-to-b from-teal-600 to-emerald-600 rounded-full"></div>
                Applied Loads
              </h3>
            ...
            <div className="space-y-5">
              <h3 className="text-xl font-bold text-slate-800 flex items-center gap-2 pb-3 border-b-2 border-cyan-600">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 p-6 rounded-xl border border-blue-100 shadow-sm mt-8">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between items-center py-1.5 border-b border-blue-100">
                    <span className="text-slate-700 font-medium">Maximum Shear Force:</span>
                    <span className="font-bold text-blue-900">{results.shearForce.toFixed(2)} kN</span>
                  </div>
                  <div className="flex justify-between items-center py-1.5 border-b border-blue-100">
                    <span className="text-slate-700 font-medium">Maximum Tensile Force:</span>
                  ...
                  <div className="flex justify-between items-center py-1.5 border-b border-blue-100">
                    <span className="text-slate-700 font-medium">Polar Moment of Inertia:</span>
                    <span className="font-bold text-blue-900">{results.ibp.toFixed(0)} mm⁴</span>
                  </div>

                  <div className="mt-6 space-y-3 pt-4 border-t-2 border-blue-200">
                  ...
                  {results.combinedRatio <= 1 ? (
                    <div className="mt-4 p-4 bg-gradient-to-r from-emerald-50 to-green-50 border-l-4 border-emerald-500 rounded-lg">
                      <p className="text-emerald-700 font-bold flex items-center text-base">
                        <span className="mr-2 text-xl">✓</span> Design is acceptable
                      </p>
                    </div>
                  ) : (
                    <div className="mt-4 p-4 bg-gradient-to-r from-red-50 to-orange-50 border-l-4 border-red-500 rounded-lg">
                      <p className="text-red-700 font-bold flex items-center text-base">
                        <AlertCircle className="w-5 h-5 mr-2" /> Design exceeds limits
                      </p>
                    </div>
                  )}
                </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-6">
                <button
                  ...
                  className="flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-lg font-semibold shadow-lg hover:shadow-xl hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 transform hover:-translate-y-0.5"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-lg font-semibold shadow-lg hover:shadow-xl hover:from-emerald-700 hover:to-teal-700 transition-all duration-300 transform hover:-translate-y-0.5"
                >
        ...
        {savedCalculations.length > 0 && (
          <div className="bg-white rounded-2xl shadow-xl ring-1 ring-slate-200 p-8 overflow-hidden transform transition-all duration-300 hover:shadow-2xl">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
              ...
              <button
                onClick={exportToCSV}
                className="flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-lg font-semibold shadow-lg hover:shadow-xl hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 transform hover:-translate-y-0.5"
              >
        ...
        {error && (
          <div className="mt-6 p-5 bg-gradient-to-r from-red-50 to-orange-50 border-l-4 border-red-500 rounded-xl shadow-lg flex items-start">
            <AlertCircle className="w-6 h-6 mr-3 text-red-600 flex-shrink-0 mt-0.5" />
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-r from-slate-50 to-blue-50 border-t border-slate-200 mt-16">
